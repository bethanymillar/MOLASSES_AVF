...
VENTS_FILE="./inputs/vent_source/vents_North_B.utm"  # Assuming you have a specific vents file for Auckland
OUTPUT_DIR="./flow_outputs/B/flowB_North"
...
while IFS= read -r line; do
  ...
  ./bin/molasses_B.ljc ./inputs/molasses_B_N.conf
