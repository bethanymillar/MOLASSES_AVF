...
VENTS_FILE="./inputs/vent_source/vents_West_B.utm"  # Assuming you have a specific vents file for Auckland
OUTPUT_DIR="./flow_outputs/B/flowB_West"
...
while IFS= read -r line; do
  ...
  ./bin/molasses_B.ljc ./inputs/molasses_B_W.conf
