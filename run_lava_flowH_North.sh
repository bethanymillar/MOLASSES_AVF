...
VENTS_FILE="./inputs/vent_source/vents_North_H.utm"  # Assuming you have a specific vents file for Auckland
OUTPUT_DIR="./flow_outputs/H/flowH_North"
...
while IFS= read -r line; do
  ...
  ./bin/molasses_H.ljc ./inputs/molasses_H.conf
