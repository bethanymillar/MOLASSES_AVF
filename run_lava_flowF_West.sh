...
VENTS_FILE="./inputs/vent_source/vents_West_F.utm"  # Assuming you have a specific vents file for Auckland
OUTPUT_DIR="./flow_outputs/F/flowF_West"
...
while IFS= read -r line; do
  ...
  ./bin/molasses_F.ljc ./inputs/molasses_F_W.conf
