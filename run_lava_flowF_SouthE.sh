...
VENTS_FILE="./inputs/vent_source/vents_SouthE_F.utm"  # Assuming you have a specific vents file for Auckland
OUTPUT_DIR="./flow_outputs/F/flowF_South"
CSV_CLEANER_SCRIPT="./scripts/convert_to_csv_F.py"
RASTER_CONVERTER_SCRIPT="./scripts/lava_flow_rasterised_F.py"

# Path to the virtual environment directory
VENV_DIR=./molasses_env_F
...
while IFS= read -r line; do
  ...
  echo "$X $Y" > ./inputs/vents_F.utm

  # Run the MOLASSES model and check if it produces an output
  ./bin/molasses_F.ljc ./inputs/molasses_F_SE.conf
